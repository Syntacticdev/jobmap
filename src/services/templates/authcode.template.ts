export function getAuthCodeTemplate(params: { email: string; otp: string | number; expirationMinutes?: number }): string {
  const expirationText = params.expirationMinutes
    ? `Verification code is valid for ${params.expirationMinutes} minutes.`
    ...
    <div style="font-family: Arial, sans-serif; background: #f4f4f4; padding: 32px;">
      <div style="max-width: 500px; margin: auto; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px #e2e8f0;">
        <div style="text-align: center; padding: 32px 0 16px 0;">
          <img src="https://img.icons8.com/color/96/000000/lock--v2.png" alt="Authentication" style="width: 64px; margin-bottom: 16px;" />
          <h2 style="color: #2d3748; margin: 0;">Your Authentication Code</h2>
        </div>
